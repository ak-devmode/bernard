...
| Platform | Group/Channel | Est. Audience | Access | Healthcare Q Frequency | Status | Notes |
|----------|--------------|---------------|--------|----------------------|--------|-------|
| WhatsApp | Business/expat community groups | Varies (50-300 per group) | Invite only | Variable | [ ] In group | Human summarizes → Bernard gets digest. Can't monitor directly. |
...
- [ ] Add any WhatsApp groups to monitor via digest
