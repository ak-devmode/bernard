...
GET  /api/radiology/queue         # Pending review queue
```
...
- Confidence threshold: 0.70 for auto-flagging
...
| **Integration Service** | Go 1.21+ | Kalpa standard, performance, concurrency, AWS SDK support |
...
| **Database** | PostgreSQL 15+ | Orthanc index, WellMed orders, audit logs |
...
- Target: Private clinics (500-1000 facilities)
...
- Infrastructure: 2.1M IDR (14%)
- ML compute: Included
- Support (10% of revenue): 1.5M IDR (10%)
- Sales/marketing (20%): 3M IDR (20%)
- R&D/overhead (15%): 2.3M IDR (15%)
- Margin target (40%): 6M IDR (40%)
- **Total price: 15M IDR/month**
...
Price: 15M IDR/month
Includes:
  - Unlimited studies (fair use: <3000/month)
...
Overage: 5,000 IDR/study beyond 3000/month
```

**Pros:**
- Predictable cost for clinic
- Simple to explain
- High perceived value

**Cons:**
- Low-volume clinics subsidize high-volume

**Option B: Per-study pricing**
```
Price: 8,000 IDR/study
Minimum: 5M IDR/month (covers ~625 studies)
...
**Cons:**
- Variable cost (clinics prefer predictable)
- Requires study counting/reconciliation

**Option C: Tiered subscription**
```
Tier 1: 8M IDR/month (up to 1000 studies)
Tier 2: 15M IDR/month (up to 2500 studies)
Tier 3: 25M IDR/month (up to 5000 studies)
Custom: 35M+ IDR/month (5000+ studies)
```

**Pros:**
- Flexibility for different clinic sizes
...
- **12M IDR/month** (20% discount)
- Annual contract: 120M IDR/year (save 24M vs monthly)
...
**Value proposition:**
- ML catches misses: Avoid 1 lawsuit/year = 500M+ IDR (ROI: 33×)
