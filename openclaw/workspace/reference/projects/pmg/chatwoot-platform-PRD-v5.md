...
| Zoho Contact Link | Text | All contacts | Contact card |
...
| Social channel inboxes (Kezia) | Facebook Page, Instagram DM, Google Business Messages — all routed to Kezia's inbox. Requires Meta page admin access and Google Business Profile verification. | Go-live stable, Meta/Google credentials ready |
